...
(() => {
  ...
  // ---- custom addition (not part of the generated dc-runtime bundle): site language
  // toggle (EN default / TH), persisted per-visitor via localStorage. Delegated click
  // listener works even though nav buttons don't exist in the DOM yet at this point
  // (they're rendered later once React boots) — matching is done at click time.
